...
const dict = {
  ...
  // Knuth backend (actions/selectNode.ts, dependencies.ts)
  Knuth: 61,
  'The pool mines through Knuth over JSON-RPC, which needs JSON-RPC enabled and the full database mode': 62,
} as const
