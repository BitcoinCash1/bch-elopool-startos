...
export const main = sdk.setupMain(async ({ effects }) => {
  ...
  const common = {
    ...
    // ckpool treats a listen port above 4000 as "highdiff" and starts it at
    // 1,000,000, whatever startdiff says. The solo port is 4567, so without
    // this CPU and small miners on it have every share rejected as too easy.
