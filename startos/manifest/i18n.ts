...
export const knuthDescription = {
  en_US:
    'A high-performance C++ Bitcoin Cash full node. Builds the block templates the pool mines on.',
  es_ES:
    'Un nodo completo de Bitcoin Cash en C++ de alto rendimiento. Construye las plantillas de bloque que mina el pool.',
  de_DE:
    'Ein leistungsstarker C++-Vollknoten für Bitcoin Cash. Erstellt die Blockvorlagen, auf denen der Pool mint.',
  pl_PL:
    'Wydajny pełny węzeł Bitcoin Cash w C++. Udostępnia szablony bloków, na których kopie kopalnia.',
  fr_FR:
    'Un nœud complet Bitcoin Cash en C++ haute performance. Construit les modèles de bloc que le pool mine.',
}
